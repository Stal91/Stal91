...
#nullable disable
    ...
    new ContaCorrente(95, "123456-X") {Saldo=100,Titular = new Cliente{Cpf="1111",Nome="Pedro"}},
    new ContaCorrente(95, "951258-X") {Saldo=200,Titular = new Cliente{Cpf="2222",Nome="Livia"}},
    new ContaCorrente(94, "987321-W") {Saldo=150,Titular = new Cliente{Cpf="3333",Nome="Henrique"}}
    };
                ...
                case 3:
                    {
                        ...
                        ExibirListaDeContas((List<ContaCorrente>)contasPorAgencia);
                        Console.ReadKey();
                        break;
                    }
                default:
        ...
        private object ConsultaPorAgencia(int numeroAgencia)
        {
            var consulta = (
