namespace bytebank.Modelos.Conta
{
	public class ContaCorrente:IComparable<ContaCorrente>
	{
        ...
        //O Globally Unique Identifier, mais conhecido como GUID,
		//ele representa um identificador global exclusivo ele é
		//utilizado para as situações que precisamos de uma sequência
		//única que não se repita para toda uma aplicação.
